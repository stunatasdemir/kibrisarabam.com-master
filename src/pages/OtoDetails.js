            ...
            <div className='details-content'>
                ...
                <div className='details-sidebar'>
                    <div className='details-info'>
                        ...
                        <ul>
                            <li><strong>Fiyat:</strong> {car.price} TL</li>
                            <li><strong>Nakite Özel Fiyat:</strong> {car.cashPrice} STG</li>
                            <li><strong>Satış Fiyatı:</strong> {car.salePrice} STG</li>
                            ...
                            <li><strong>Tork:</strong> {car.torque} Nm</li>
                            <li><strong>Yakıt Tüketimi:</strong> {car.fuelConsumption} lt/100 km</li>
                            <li><strong>Yakıt Deposu:</strong> {car.fuelTankCapacity} lt</li>
                            <li><strong>Boya-değişen:</strong> {car.paintCondition}</li>
                        </ul>
                    </div>
                    <div className='details-contact'>
                        <h2>İletişim</h2>
                        <a href="tel:+901234567890" className="contact-button">
                            <PhoneLogo />
                            <span>Telefonu Göster</span>
                        </a>
                        <a href="https://wa.me/+901234567890" className="contact-button">
                            <WhatsappLogo />
